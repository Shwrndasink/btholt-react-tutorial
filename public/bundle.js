...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = redux.createStore(rootReducer, initialState, redux.compose((typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && typeof window.devToolsExtensions !== 'undefined' ? window.devToolsExtension() : function (f) {
	  return f;
	}));
	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function assignShow(id) {
	      var showArray = this.porps.shows.filter(function (show) {
